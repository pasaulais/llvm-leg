...
SDNode *LEGDAGToDAGISel::SelectFrameIndex(SDNode *N) {
  int FI = cast<FrameIndexSDNode>(N)->getIndex();
  SDValue FIVal(CurDAG->getTargetFrameIndex(FI, MVT::i32));
  return CurDAG->getMachineNode(LEG::MOVLOi16, N, MVT::i32, FIVal);
}
